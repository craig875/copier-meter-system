    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Link to="/connectivity" className="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50">Back to Dashboard</Link>
          <Link to="/connectivity/targets/new" className="flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700">
              ...
              targets.map((t) => (
                <tr key={t.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3 text-sm">
                    <Link to={`/connectivity/targets/${t.id}`} className="text-blue-600 hover:underline">{t.customerName}</Link>
                  </td>
                  <td className="px-4 py-3 text-sm">
                    <Link to={`/connectivity/targets/${t.id}`} className="text-blue-600 hover:underline">{t.siteName}</Link>
                  </td>
                  ...
                  <td className="px-4 py-3 text-sm font-mono">
                    <Link to={`/connectivity/targets/${t.id}`} className="text-blue-600 hover:underline">{t.monitoringTarget}</Link>
                  </td>
                  ...
                  <td className="px-4 py-3 text-right">
                    ...
                    <Link to={`/connectivity/targets/${t.id}`} className="p-2 text-gray-500 hover:text-blue-600 inline-block" title="View"><Eye className="h-4 w-4" /></Link>
                    <Link to={`/connectivity/targets/${t.id}/edit`} className="p-2 text-gray-500 hover:text-blue-600 inline-block" title="Edit"><Pencil className="h-4 w-4" /></Link>
