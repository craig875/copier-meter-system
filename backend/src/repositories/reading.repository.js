...
export class ReadingRepository extends BaseRepository {
  ...
  async upsertReading(data) {
    ...
    const cleanData = {
      ...
      unableToRead: data.unableToRead === true,
      unableToReadReason: data.unableToReadReason || null,
      unableToReadOverride: data.unableToReadOverride === true,
      unableToReadOverrideReason: data.unableToReadOverrideReason || null,
      unableToReadOverrideBy: data.unableToReadOverrideBy || null,
      unableToReadOverrideAt: data.unableToReadOverrideAt ?? null,
    ...
    const createData = {
      ...
      unableToRead: cleanData.unableToRead === true,
      unableToReadReason: cleanData.unableToReadReason,
      unableToReadOverride: cleanData.unableToReadOverride === true,
      unableToReadOverrideReason: cleanData.unableToReadOverrideReason,
      unableToReadOverrideBy: cleanData.unableToReadOverrideBy,
      unableToReadOverrideAt: cleanData.unableToReadOverrideAt,
